      ...
      <div className="form-grid" style={{ display: 'grid', gridTemplateColumns: `repeat(${activeCount || 1}, 1fr)`, gap: '1.5rem' }}>
        {showAz && (
          <div className="form-section">
            ...
            <input className="form-control" type="text" name="name_az" value={formData.name_az} onChange={handleInputChange} required={showAz} />

            <label className="form-label" style={{ marginTop: '1rem' }}>{l.desc} (AZ)</label>
            <textarea className="form-control" name="desc_az" rows="4" value={formData.desc_az} onChange={handleInputChange} required={showAz} />
          </div>
        )}
        {showEn && (
          <div className="form-section">
            <label className="form-label">{l.name} (EN)</label>
            <input className="form-control" type="text" name="name_en" value={formData.name_en} onChange={handleInputChange} required={showEn} />
        ...
        {(showAz || showEn || showRu) ? (
          <div className="file-dropzone">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              ...
              {showEn && (
                <div style={{ marginTop: showAz ? '0.5rem' : 0 }}>
